    ...
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg z-20">
        <div className="flex justify-around items-center p-2">
          <Link href="/">
            <div className={`flex flex-col items-center justify-center p-2 cursor-pointer ${isActive("/") ? "text-primary" : "text-gray-500"}`}>
          ...
          <Link href="/settings">
            <div className={`flex flex-col items-center justify-center p-2 cursor-pointer ${isActive("/settings") ? "text-primary" : "text-gray-500"}`}>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
